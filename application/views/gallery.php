							...
							<div class="col-md-8 col-lg-8 col-sm-8 col-xs-12">
								<div class="gallery-area">
									...
									<div id="filters" class="button-group">  
										<button class="button is-checked" data-filter="*">All Works</button>
										<?php foreach ($category as $v):
											if($v->CAT_ID == $gallery[0]['CAT_ID']){
										 ?>
									    	<button class="button" data-filter=".metal-<?php echo $v->SUB_CATEGORY_ID; ?>"><?php echo $v->SUB_CATEGORY_NAME; ?></button>
									    <?php }endforeach; ?>
									</div>
									<div class="isotope gallery-img">
										<?php foreach ($gallery as $vg): ?>
											<div class="element-item transition metal-<?php echo $vg['SUB_CAT_ID']; ?> col-md-4 col-lg-4 col-sm-6 col-xs-12" data-category="transition">
												<a class="example-image-link" href="<?php echo $this->webspice->get_path('gallery').$vg['IMAGE_ID'].'.jpg'; ?>" data-lightbox="example-1">
													<img src="<?php echo $this->webspice->get_path('gallery').$vg['IMAGE_ID'].'.jpg'; ?>" class="img-responsive" alt="#"/>
												</a>
											</div>
										<?php endforeach; ?>
									</div>
