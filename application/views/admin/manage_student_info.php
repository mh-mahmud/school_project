                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Manage Student Info</div>
                            </div>
                                                ...
                                                <td>
                                                  <div class="btn-group" role="group">
                                                    ...
                                                    <ul class="dropdown-menu customized-menu">
                                                      ...
                                                      <li>
                                                        <?php if( $this->webspice->permission_verify('manage_student_info',true) && $v->STATUS==7 ): ?>
                                                            <a href="<?php echo $url_prefix; ?>manage_student_info/inactive/<?php echo $this->webspice->encrypt_decrypt($v->STUDENT_ID,'encrypt'); ?>" class="btn btn-warning">Inactive</a>
                                                        <?php endif; ?>
                                                      </li>
                                                      <li>
                                                        <?php if( $this->webspice->permission_verify('manage_student_info',true) && $v->STATUS==-7 ): ?>
                                                            <a href="<?php echo $url_prefix; ?>manage_student_info/active/<?php echo $this->webspice->encrypt_decrypt($v->STUDENT_ID,'encrypt'); ?>" class="btn btn-warning">Active</a>
                                                        <?php endif; ?>
                                                      </li>
                                                      <li>
                                                        <?php if( $this->webspice->permission_verify('manage_student_info',true)): ?>
                                                            <a href="<?php echo $url_prefix; ?>manage_student_info/delete/<?php echo $this->webspice->encrypt_decrypt($v->STUDENT_ID,'encrypt'); ?>" class="btn btn-danger">Delete</a>
                                                        <?php endif; ?>
                                                      </li>
                                                    </ul>
                                                  </div>
