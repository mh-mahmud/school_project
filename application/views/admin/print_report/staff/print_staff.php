...
<div id="printArea">
    ...
    <table class="table" width="100%" border="1" cellpadding="0" cellspacing="0">
      ...
      <tr style="height:100px;">    
          <td align="center" style="vertical-align:middle"><?php echo $v->STAFF_CARD_NO; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $v->STAFF_NAME; ?></td>
          ...
          <td align="center" style="vertical-align:middle"><?php echo $v->STAFF_BIRTHDAY; ?></td>
          <td align="center" style="vertical-align:middle">
								<img src="<?php echo $this->webspice->settings()->site_url.'global/custom_files/staff/'.$v->STAFF_ID.'.jpg'; ?>"  alt="Teacher Photograph" class="img-responsive" width="100" />
			</td>
