...
$total_column = 13;
$report_name = 'Teacher Information';
...
<div id="printArea">
    ...
    <table class="table" width="100%" border="1" cellpadding="0" cellspacing="0">
      ...
      <tr style="height:100px;">    
          <td align="center" style="vertical-align:middle"><?php echo $v->TEACHER_NAME; ?></td>
          ...
          <td align="center" style="vertical-align:middle"><?php echo $v->TEACHER_BIRTHDAY; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $v->PRESENT_ADDRESS; ?></td>
          <td align="center" style="vertical-align:middle">
								<img src="<?php echo $this->webspice->settings()->site_url.'global/custom_files/teacher/'.$v->TEACHER_ID.'.jpg'; ?>"  alt="Teacher Photograph" class="img-responsive" width="100" />
					</td>
