...
$total_column = 8;
$report_name = 'Payment Category Information';
...
<div id="printArea">
    ...
    <table class="table" width="100%" border="1" cellpadding="0" cellspacing="0">
      ...
      <tr style="height:100px;">    
          <td align="center" style="vertical-align:middle"><?php echo $v->CATEGORY_NAME; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $v->CATEGORY_DESCRIPTION; ?></td>
