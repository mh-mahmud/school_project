...
$total_column = 10;
$report_name = 'Payment Information';
    ...
    <table class="table" width="100%" border="1" cellpadding="0" cellspacing="0">
      ...
      <tr style="height:100px;">    
          <td align="center" style="vertical-align:middle">
          	<?php  
          		$cat = $this->db->query("SELECT CATEGORY_NAME FROM payment_category WHERE  PAYMENT_CAT_ID=".$v->PAYMENT_CAT_ID)->result();
          ...
          <td align="center" style="vertical-align:middle"><?php echo $v->AMOUNT; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $v->YEAR; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $v->MONTH; ?></td>
