...
$total_column = 13;
$report_name = 'Parent Information';
...
<div id="printArea">
    ...
    <table class="table" width="100%" border="1" cellpadding="0" cellspacing="0">
      ...
      <tr style="height:100px;">    
          <td align="center" style="vertical-align:middle"><?php echo $v->PARENT_NAME; ?></td>
          ...
          <td align="center" style="vertical-align:middle"><?php echo $v->RELATION_WITH_STU; ?></td> 
          ...
          <td align="center" style="vertical-align:middle"><?php echo $v->NATIONAL_ID_NO; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $v->OCCOPATION; ?></td>
          ...
          <td align="center" style="vertical-align:middle">
								<img src="<?php echo $this->webspice->settings()->site_url.'global/custom_files/parent/'.$v->PARENT_ID.'.jpg'; ?>"  alt="Teacher Photograph" class="img-responsive" width="100" />
					</td>
