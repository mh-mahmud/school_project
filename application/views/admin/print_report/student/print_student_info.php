...
<div id="printArea">
    ...
    <table class="table" width="100%" border="1" cellpadding="0" cellspacing="0">
      ...
      <tr style="height:100px;">    
          <td align="center" style="vertical-align:middle"><?php echo $v->NAME; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $v->BIRTHDAY; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $v->GENDER; ?></td> 
          <td align="center" style="vertical-align:middle"><?php echo $v->RELIGION; ?></td>
          <td align="center" style="vertical-align:middle"><?php echo $v->BLOOD_GROUP; ?></td>
          ...
          <td align="center" style="vertical-align:middle"><?php echo $v->PUBLIC_ID; ?></td>
          <td align="center" style="vertical-align:middle">
								<img src="<?php echo $this->webspice->settings()->site_url.'global/custom_files/student/'.$v->STUDENT_ID.'.jpg'; ?>"  alt="Student Photograph" class="img-responsive" width="100" />
					</td>
