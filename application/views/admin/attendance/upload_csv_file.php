                      ...
                      <div class="row-fluid">
                        ...
                        <div class="block">
                          <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">Upload CSV File</div>
                          </div>
                            ...
                            <div class="span12">
                              ...
                              <form method="post" action=""  enctype="multipart/form-data" id="" class="form-horizontal">
                                  ...
                                  <fieldset>
                                    ...
                                    <div class="control-group">
                                      <label class="control-label" for="upload_data_file">Upload File<span class="required">*</span></label>
                                      <div class="controls">
                                        <input type="file" name="upload_data_file" class="input-file uniform_on" id="upload_data_file" required>
                                      </div>
                                      <span class="fred"><?php echo form_error('upload_data_file'); ?></span>
                                    </div>
