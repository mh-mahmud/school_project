                                      ...
                                      <?php if(count($students)) { ?>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                                            ...
                                            <tr>
                                                ...
                                                <th>Roll No</th>
                                                <?php
                                                  foreach($subject_columns as $sub_val) {
                                                    $sub_val_data = strtolower(str_replace('_', ' ', $sub_val));
                                                    echo "<th>".ucwords($sub_val_data)."</th>";
                                                  }
                                                ?>
                                                <th>Comment</th>
                                            </tr>
                                            ...
                                            <tr>
                                              ...
                                              <?php
                                              foreach($subject_columns as $sub_data) {
                                                $sub_data_2 = strtolower($sub_data);
                                              ?>
                                              <td>
                                                <div class="control-group">
                                                    <!-- <label class="control-label">Staff Name<span class="required">*</span></label> -->
                                                    <div class="controls">
                                                        <input type="text" name="<?php echo $sub_data_2; ?>[]" data-required="1" class="span6 m-wrap" value="<?php echo set_value($sub_data_2,$edit[$sub_data]); ?>" />
                                                        <span class="fred"><?php echo form_error(); ?></span>
                                                    </div>
                                                </div>
                                              </td>
                                              <?php } ?>
