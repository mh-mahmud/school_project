                        ...
                        <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Student admit card</div>
                                </div>
                                              ...
                                              <div class="controls">
                                                <select class="span6 m-wrap" name="exam_id">
                                                  ...
                                                  <?php
                                                    ...
                                                    $options = $this->db->query("SELECT e.EXAM_NAME, e.EXAM_ID FROM exam AS e WHERE e.STATUS = 7")->result();
                                                   
                                                  ?>
                                                  <?php  foreach($options as $option) :?>
                                                    <option value="<?php echo $option->EXAM_ID?>" <?php echo (isset($edit['EXAM_ID']) && $edit['EXAM_ID'] == $option->EXAM_ID) ? "selected" : ""; ?> ><?php echo $option->EXAM_NAME ?></option>
                                                  <?php endforeach; ?>
                                                </select>
