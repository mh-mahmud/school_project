                        ...
                        <!-- alert message end -->
                          ...
                          <div class="navbar">
                              <div class="navbar-inner">
                                  <ul class="breadcrumb">
                                      <li>
                                          <b>Create Student Testimonial</b>
                                      </li>
                                  </ul>
                              </div>
                          </div>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Create Student Testimonial</div>
                                </div>
                                        ...
                                        <fieldset>
                                              ...
                                              <div class="control-group">
                                                  ...
                                                  <div class="controls">
                                                    ...
                                                    <select id="student_list" class="span6 m-wrap" name="group">
                                                      <option value="">Select...</option>
                                                      <option value="Science">Science</option>
                                                      <option value="Arts">Arts</option>
                                                      <option value="Commerce">Commerce</option>
                                                    </select>
                                                      <span class="fred"><?php echo form_error('group'); ?></span>
                                                  </div>
                                              </div>
                                              ...
                                              <div class="control-group">
                                                  <label class="control-label">SSC Roll No<span class="required">*</span></label>
                                                  <div class="controls">
                                                      <input type="text" name="ssc_roll_no" data-required="1" class="span6 m-wrap" value="<?php echo set_value('ssc_roll_no',$edit['SSC_ROLL_NO']); ?>" />
                                                      <span class="fred"><?php echo form_error('ssc_roll_no'); ?></span>
                                                  </div>
                                              </div>
                                              ...
                                              <div class="control-group">
                                                  ...
                                                  <div class="controls">
                                                      <input type="text" name="registration_no" data-required="1" class="span6 m-wrap" value="<?php echo set_value('registration_no',$edit['REGISTRATION_NO']); ?>" />
                                                      <span class="fred"><?php echo form_error('registration_no'); ?></span>
                                                  </div>
                                              </div>

                                              <div class="control-group">
                                                  <label class="control-label">GPA<span class="required">*</span></label>
                                                  <div class="controls">
                                                      <input type="text" name="gpa" data-required="1" class="span6 m-wrap" value="<?php echo set_value('gpa',$edit['GPA']); ?>" />
                                                      <span class="fred"><?php echo form_error('gpa'); ?></span>
                                                  </div>
                                              </div>
