                        ...
                        <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Student Transfer Certificate</div>
                                </div>
                                    ...
                                    <div class="span12">
                                                ...
                                                <form method="post" action=""  enctype="multipart/form-data" id="" class="form-horizontal">
                                                    ...
                                                    <fieldset>
                                                          ...
                                                          <div class="control-group">
                                                              <label class="control-label">Post Office Name<span class="required">*</span></label>
                                                              <div class="controls">
                                                                  <input type="text" name="post_office" data-required="1" class="span6 m-wrap" value="<?php echo set_value('post_office',$edit['POST_OFFICE']); ?>" />
                                                                  <span class="fred"><?php echo form_error('post_office'); ?></span>
                                                              </div>
                                                          </div>
                                                          ...
                                                          <div class="control-group">
                                                              ...
                                                              <div class="controls">
                                                                  <input type="text" name="district" data-required="1" class="span6 m-wrap" value="<?php echo set_value('district',$edit['DISTRICT']); ?>" />
                                                                  <span class="fred"><?php echo form_error('district'); ?></span>
                                                              </div>
                                                          </div>

                                                          <div class="control-group">
                                                              <label class="control-label">Police Station<span class="required">*</span></label>
                                                              <div class="controls">
                                                                  <input type="text" name="police_station" data-required="1" class="span6 m-wrap" value="<?php echo set_value('police_station',$edit['POLICE_STATION']); ?>" />
                                                                  <span class="fred"><?php echo form_error('police_station'); ?></span>
                                                              </div>
                                                          </div>

                                                          <div class="control-group">
                                                              <label class="control-label">Release Date<span class="required">*</span></label>
                                                              <div class="controls">
                                                                  <input type="text" name="release_date" data-required="1" class="span6 m-wrap datepicker" value="<?php echo set_value('release_date',$edit['RELEASE_DATE']); ?>" />
                                                              <span class="fred"><?php echo form_error('release_date'); ?></span>
                                                              </div>
                                                          </div>
