            <hr>
            <footer>
                <p class="pull-left">&copy; Comilla Yusuf School</p>
                <div class="pull-right">
                    <div class="footer_img">
                        <a target="_blank" href="http://foxtechnologies.net"><img title="Fox Technologies" src="<?php echo $url_prefix; ?>global/img/fox_logo.png"></a>
                    </div>
                </div>
            </footer>
        </div>
