...
<head>
    ...
    <?php if( $this->uri->segment(2)=='monthly_money_recipt'): ?>
                ...
                <table class="table table-hover">
                    ...
                    ?>
                        <tr>
                            <td class="col-md-5" style="">
                                <?php echo ucwords($service->MONTH); ?>
                            </td>
                            <td class="col-md-5"><em>Monthly Fee</em></h4></td>
                    ...
                    <?php $i++; endforeach; ?>
                        <tr>
                            ...
                            <p>
                                <strong>Less / Scholarship: </strong>
                            </p></td>
                            ...
                            <p>
                                <strong><?php echo $trans_data[0]->DISCOUNT; ?></strong>
                            </p></td>
                        </tr>
                        <tr>
                            <td>   </td>
                            ...
                            <td class="text-center text-danger" style="color: #D12122;"><h4><strong><?php echo $trans_data[0]->SUB_TOTAL; ?>/-</strong></h4></td>
                        </tr>
                    </tbody>
                </table>
