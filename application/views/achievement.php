            ...
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                <div class="container-section">
                    <div class="col-md-8 col-lg-8 col-sm-8 col-xs-12">
                        <div class="cultural-activity-area">
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                                    <div class="cultural-img">
                                        <?php if( file_exists($this->webspice->get_path('achievement_full').$v->ACHIEVEMENT_ID.'.jpg') ): ?>
                                            <img src="<?php echo $this->webspice->get_path('achievement').$v->ACHIEVEMENT_ID.'.jpg'; ?>" class="img-responsive img-thumbnail" alt="achievement.jpg">
                                        <?php endif;  ?>
                                        <h4><?php echo $v->TITLE; ?></h4>
                                        <p><?php echo substr($v->DETAILS, 0 , 50); ?> <a href="<?php echo $url_prefix; ?>education/single_achievement/<?php echo $v->ACHIEVEMENT_ID; ?>">Read More</a></p>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
