                            ...
                            <div class="block">
                                ...
                                <div class="block-content collapse in">
                                    <div class="span12">
                                        ...
                                        <form id="" action="<?php echo $url_prefix; ?>change_password/<?php echo $this->webspice->encrypt_decrypt($user_id, 'decrypt'); ?>" class="form-horizontal" method="post" data-parsley-validate>
