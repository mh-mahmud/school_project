                ...
                <div class="container-section">
                    <div class="col-md-8 col-lg-8 col-sm-8 col-xs-12">
                        <div class="cultural-activity-area">
                            ...
                            <?php foreach($cultural_activities as $v):?>
                                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                                    <div class="cultural-img">
                                        ...
                                        <p><?php echo substr($v->DETAILS, 0 , 50); ?> <a href="<?php echo $url_prefix; ?>education/single_activities/<?php echo $v->CULTURAL_ACTIVITIES_ID; ?>">Read More</a></p>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
